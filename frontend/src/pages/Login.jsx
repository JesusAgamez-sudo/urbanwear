    ...
    <div className="container px-4 py-8 mx-auto max-w-md">
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="bg-black text-white py-4 px-6">
          ...
          <p className="text-gray-300">Accede a tu cuenta de UrbanWear</p>
        </div>
        ...
        <form className="p-6">
          ...
          <button type="submit" className="btn-primary w-full mb-4">Iniciar sesión</button>
          
          <div className="text-center">
            <p className="text-gray-700">
              ¿No tienes una cuenta?{' '}
              <Link to="/registro" className="text-purple-600 hover:text-purple-800 font-bold">Regístrate</Link>
            </p>
          </div>
        </form>
      </div>
